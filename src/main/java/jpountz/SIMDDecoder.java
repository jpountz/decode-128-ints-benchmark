...
public class SIMDDecoder {
  ...
  private static void decode1(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
  ...
  private static void decode2(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 4; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode3(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode4(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 8; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode5(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode6(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 4; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode7(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode8(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 16; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode9(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode10(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 4; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode11(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode12(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 8; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode13(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode14(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 4; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode15(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 2; ++k) {
      long block0 = in.getLong();
  ...
  private static void decode16(ByteBuffer in, long[] intPairs) {
    int idx = 0;
    for (int k = 0; k < 32; ++k) {
      long block0 = in.getLong();
